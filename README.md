...
- **GoGoPool** — Decentralized validator marketplace  
- **IPFS & S3** — Hybrid decentralized metadata storage  

---

## 🛠️ Tech Stack

- Solidity (ERC721, LayerZero cross-chain)
- Hardhat & Foundry
...
| Project | Description |
|---------|-------------|
| `players-ink-coa` | NFT redemption flow for signed collectibles |
| `blockticity-minting` | L1-native COA minting + trait metadata |
| `xdc-redemption-mvp` | Gasless NFT redemption using XDC Apothem testnet |
| `onesource-indexing` | RWA indexing and search engine |
| `coai-models` | AI/ML for fraud detection, canopy analysis, and yield forecasting |
...
> Stay tuned — public contracts, SDKs, and dashboards coming soon.
